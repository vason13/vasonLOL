...
main(void)
{
...
#else
    SysCtlClockSet(SYSCTL_SYSDIV_5|SYSCTL_USE_PLL|SYSCTL_OSC_MAIN|SYSCTL_XTAL_16MHZ); //use this clock configuration for the temperature
    ...
    //
    pui32DataTx[0] = ui32TempValueF;    //assign index 0 to Fahrenheit temperature
    pui32DataTx[1] = ui32TempValueC;    //assignindex 1 to Celsius temperature 
    ...
    for(ui32Index = 0; ui32Index < NUM_SSI_DATA; ui32Index++)
    {
        ...
        //
        if(ui32Index == 0)
            UARTprintf(" Fahrenheit = %3d ", pui32DataTx[ui32Index]);   //print index 0 with "Fahrenheit"
        if(ui32Index == 1)
            UARTprintf(" Celsius = %3d ", pui32DataTx[ui32Index]);  //print index 1 with "Celsius"
        //
