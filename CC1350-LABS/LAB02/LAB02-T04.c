  ...
  void gpioButtonFxn0(uint_least8_t index)
  {
      ...
      if(threshold < 250){ //ensure threshold does not go below zero
          threshold = 0;

      }
      else{
          threshold -= 250; //decrement threshold by 250
      }
  }

  /*
   * =======gpioButtonFxn1======
   * Callback function for the GPIO interrupt on Board+GPIO_BUTTON1
   */
  ...
  void gpioButtonFxn1(uint_least8_t index)
  {
      ...
      if(threshold > 4095)
      {
          ...
          threshold += 250; //increment threshold by 250
      }
  }
  /*
   *  ======== mainThread ========
